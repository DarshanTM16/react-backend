      ...
      <footer>
        <div className="top-post-container">
          <div className="main-image">
            <img src='https://wallpapercave.com/wp/wp9781435.jpg' alt="" />
          ...
          <div className="tp1 tp">
            <Link to="/hollydata" className='blink'>
              <div className="tpimage-1">
                <img src='https://wallpapercave.com/wp/wp10420275.jpg' alt="" height="100%" width="100%" />
          ...
          <div className="tp2 tp">
            <Link to="/traveldata" className='blink'>
              <div className="tpimage-2">
                <img src='https://wallpapercave.com/wp/wp1921785.jpg' alt="" height="100%" width="25%" />
          ...
          <div className="tp3 tp">
            <Link to="/bollywoodata" className='blink'>
              <div className="tpimage-3">
                <img src='https://wallpapercave.com/wp/wp8022670.png' alt="" height="100%" width="25%" />
          ...
          <div className="tp4 tp">
            <Link to="/techdata" className='blink'>
              <div className="tpimage-4">
                <img src='https://wallpapercave.com/wp/wp9013042.jpg' alt="" height="100%" width="25%" />
